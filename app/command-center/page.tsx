...
// Stable pulse heights (no Math.random on render)
const pulseHeights = [18, 28, 15, 32, 22, 19, 27, 14, 31, 25, 20, 29, 16, 33, 21, 17, 26, 13, 30, 24, 19, 28, 15, 32, 22, 18, 27, 14, 31, 23]
...
const areaData = [
  ...
  { name: "Upper", value: 38718, color: "#22c55e" },
...
const topShops = [
  { code: "S-0074-005", name: "Dubai Phone",               area: "Cairo", project: "Elite", sellout: 3042, revenue: "63.1M", brand: "Oppo"    },
  { code: "S-0074-006", name: "Dubai Phone (City Center)", area: "Cairo", project: "Elite", sellout: 2495, revenue: "63.4M", brand: "Samsung" },
  { code: "S-0074-008", name: "Dubai Phone (Mohandseen)",  area: "Cairo", project: "Elite", sellout: 2247, revenue: "49.2M", brand: "Samsung" },
  { code: "S-0074-020", name: "Dubai Phone (Smouha)",      area: "Alex",  project: "Elite", sellout: 1942, revenue: "51.7M", brand: "Samsung" },
  { code: "S-0074-022", name: "Dubai Phone (Mosdak)",      area: "Cairo", project: "Elite", sellout: 1923, revenue: "39.9M", brand: "Oppo"    },
]
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <Card className="lg:col-span-2 bg-neutral-900 border-neutral-700">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-neutral-400">TOTAL SELLOUT</span>
        ...
        <Card className="lg:col-span-2 bg-neutral-900 border-neutral-700">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-neutral-400">ACTIVE SHOPS</span>
        ...
        <Card className="lg:col-span-3 bg-neutral-900 border-neutral-700">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-neutral-400">INTEGRITY FLAGS</span>
        ...
        <Card className="lg:col-span-4 bg-neutral-900 border-neutral-700">
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={180}>
              <PieChart>
                <Pie data={areaData} cx="50%" cy="50%" innerRadius={40} outerRadius={70} dataKey="value">
        ...
        <Card className="lg:col-span-12 bg-neutral-900 border-neutral-700">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-neutral-500">from MBL_Raw_Data_W19_W22</span>
            </div>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {topShops.map((shop) => (
                    <tr key={shop.code} className="border-b border-neutral-800 hover:bg-neutral-800/50 transition-colors">
                      ...
                      <td className="py-3 px-2">
                        <span className="px-2 py-0.5 bg-purple-500/20 text-purple-400 rounded text-xs">{shop.project}</span>
                      </td>
                      <td className="py-3 px-2 text-right font-mono text-emerald-400">{shop.sellout.toLocaleString()}</td>
